...
const hasChildrenValues = (arr, character) => {
    ...
    let result=false;
    arr.forEach(val => {
        if (Object.values(val)[0] === character && Object.values(val)[2].length > 0) {
             result = true;
        } 
    })
    return result;
...
const hasChildrenEntries = (arr, character) => {
    ...
    let result=false;
    arr.forEach(val => {
        if (Object.entries(val)[0][1] === character && Object.entries(val)[2][1].length > 0) {
             result = true;
        } 
    })
    return result;
...
const totalCharacters = (arr) => {
    ...
    arr.forEach(obj => {
      ...
      let inside = names[2].length;
      if(inside > 0 ){
        totalCharacters = totalCharacters + inside;
      }
    });
